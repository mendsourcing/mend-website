    ...
    <>
      ...
      <section className="py-16 md:py-24 px-6 md:px-15">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Reveal direction="left" className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-10">
            ...
            <Reveal direction="right" className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-10">
              <div className="text-xs uppercase tracking-[3px] text-[#03ACED] font-semibold mb-4">
                Vision
              </div>
              <p className="text-sm text-[#bbb] leading-relaxed">
      ...
      <section className="py-16 md:py-24 px-6 md:px-15 bg-gradient-to-b from-[#0a0a0a] to-[#0d1117]">
        <div className="max-w-7xl mx-auto text-center">
          <Reveal direction="up" as="h2" className="text-3xl font-bold mb-4">Come Work With Us!</Reveal>
          <Reveal direction="up" delay={80} as="p" className="text-[#bbb] max-w-xl mx-auto mb-8">
          ...
          <Reveal direction="up" delay={160}>
            ...
            >
              Apply With Us <span className="inline-block transition-transform duration-300 group-hover:translate-x-1">→</span>
            </a>
          </Reveal>
        </div>
      </section>
